            ...
            <div class=" cart-container ">
              ...
              <table class="fl-1 ta-r">
                ...
                <tr>
                  ...
                  <td>
                    <p class="fl-1 ta-r cart-details-text3"><?php echo number_format($values['total_price'],2); ?> £ EGP </p>
                  </td>
                </tr>
              </table>
          ...
          <div class=" cart-container ">
            ...
            ?>  
                  <div class="payment-details">
                    <div class="flex mb-10"> <b class="fl-1"><?php echo $hike_info['name'].', '.$hike_info['location']; ?></b>
                      <p class="fl-1 ta-r"><?php echo number_format($values['total_price'],2); ?> £</p>
                    </div>
                  </div>
            <?php
            ...
            ?>
              ...
              <div class="payment-details">
                ...
                <a href="index.php"> <div class="mb-a xbutton grey  "> Continue exploring </div> </a>
              </div>
            </div>
          </div>
          <!-- Cart Details END -->
