									...
									<div class="col-md-8" style="margin: 0 auto;">
										...
										<div class="card card-warning">
											<div class="card-header">
												<h3 class="card-title">Add Group</h3> </div>
											<!-- /.card-header -->
											<div class="card-body">
													...
													<div class="row">
														<div class="col-sm-12">
															...
															<div class="form-group">
																<label>Name </label>
																<input type="text" name="name" class="form-control" placeholder="Enter The Name Of The Group .."> </div>
														</div>
													</div>
													<div class="row">
														<div class="col-sm-12">
															...
															<div class="form-group">
																...
																<input type="text" name="location" class="form-control" placeholder="Enter The Location .."> </div>
														</div>
													</div>
													<div class="row">
														<div class="col-sm-12">
                                                    ...
                                                    <div class="row">
														<div class="col-sm-12">
															...
															<div class="form-group">
																...
																<input type="number" name="price" min="0" class="form-control" placeholder="Enter The Price Per Day .."> </div>
														</div>
													</div>
                                                    <div class="row">
                                                        <div class="col-sm-9">
